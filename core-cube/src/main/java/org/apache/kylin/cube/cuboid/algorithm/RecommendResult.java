...
public class RecommendResult {
    ...
    public static class Builder {
        ...
        public Builder setOptimizationBenefitModel(OptimizationBenefit optBenefit) {
    ...
    public RecommendResult(Map<Long, Long> recommendCuboids, OptimizationBenefit optBenefit) {
        this.recommendCuboids = recommendCuboids;
        this.optBenefit = optBenefit;
    }
