...
import org.apache.kylin.measure.topn.BiTopNMeasureType;
import org.apache.kylin.measure.topn.TopNMeasureType;
import org.apache.kylin.measure.topn.extend.ExBiTopNMeasureType;
...
abstract public class MeasureTypeFactory<T> {
    ...
    public static synchronized void init() {
        ...
        factoryInsts.add(new BiTopNMeasureType.Factory());
        factoryInsts.add(new ExBiTopNMeasureType.Factory());
        factoryInsts.add(new ExTopNMeasureType.Factory());
