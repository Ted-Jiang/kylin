...
public class TopNMeasureType extends TopNMeasureTypeBase<ByteArray, TopNCounter<ByteArray>> {
    ...
    public MeasureIngester<TopNCounter<ByteArray>> newIngester() {
        return new TopNMeasureIngester<ByteArray, TopNCounter<ByteArray>>() {

            protected TopNCounter<ByteArray> valueOf(String[] values) {
                // Construct key
            ...
            protected TopNCounter<ByteArray> reEncodeDictionary(TopNCounter<ByteArray> value) {
